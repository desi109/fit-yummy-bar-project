...
export declare function findProjectUsingFile(projectGraph: ProjectGraph, file: string): ProjectGraphNode<any>;
export declare function findSourceProject(projectGraph: ProjectGraph, sourceFilePath: string): ProjectGraphNode<any>;
export declare function findTargetProject(projectGraph: ProjectGraph, targetFile: string): ProjectGraphNode<any>;
