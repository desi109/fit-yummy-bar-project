import { GeneratorCallback, NxJsonProjectConfiguration, ProjectConfiguration, Tree } from '@nrwl/devkit';
...
export declare class ProjectConverter {
     ...
     */
    convertRootTSLintConfig(applyPackageSpecificModifications: (json: Linter.Config) => Linter.Config): Promise<Exclude<GeneratorCallback, void>>;
